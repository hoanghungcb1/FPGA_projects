...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+4,"z",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    {
        ...
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(1, "design_4.state", 4, 2, __VenumItemNames, __VenumItemValues);
    }
    tracep->declBus(c+5,"y",1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
    tracep->declBus(c+6,"ctn_y",1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->top__DOT__dut__DOT__y),2);
    bufp->fullCData(oldp+6,(vlSelf->top__DOT__dut__DOT__ctn_y),2);
}
